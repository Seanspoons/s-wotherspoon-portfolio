...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-10 border-b border-primary/5 bg-surface/80 dark:bg-[#050816]/80 backdrop-blur">
      <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-4">
          <nav className="hidden gap-6 text-sm text-primary/70 dark:text-slate-200 md:flex">
            <a href="#projects" className="hover:text-accent">Projects</a>
            <a href="#stack" className="hover:text-accent">Stack</a>
          ...
          <button
            type="button"
            onClick={toggleTheme}
            className="h-8 w-8 flex items-center justify-center rounded-full bg-paper dark:bg-[#111827] ring-1 ring-primary/10 text-xs focus-visible-ring"
